...
const ViewResults = props => {
    ...
    let [quizList,setQuizList] = useState([
        {_id:'',title:'',time:'',timeLimit:'',writerMail:''},
    ]);

    useEffect(() => {
        console.log(props.location.state.creatorMail,props.location.state.quizTitle);
        axios.post("http://localhost:4000/test/creator/fetchTestAttemptDetails",
            {
